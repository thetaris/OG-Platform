...
/**
 * Contains empty implementations of EWrapper methods. 
 * Extend and override any methods the OpenGamma integration should support.
 */
public abstract class AbstractBaseWrapper implements EWrapper {
